...
> 后续范围已调整：本阶段交付与验收记录保持不变；以下历史文本中关于下一阶段便携助手的安排已取消。当前接续任务以 [安装身份基础计划](2026-09-15-installer-identity.md) 和 [仅安装版在线更新设计](../specs/2026-09-15-installer-only-update-design.md) 为准。
