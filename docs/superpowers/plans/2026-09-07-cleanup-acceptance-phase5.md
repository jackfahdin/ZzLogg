...
旧新版单文件大日志对照现已完成，报告记录了轻微滚动回退信号，尚未定位原因，不能宣称性能全面通过。Windows 人工多屏/DPI 验收仍未完成。Linux/macOS 继续暂停，不作为当前阻塞项。详见 [验收收尾计划](2026-09-14-ui-acceptance-followup.md)。下面的“未合并”和 XFAIL 描述仅是早期历史记录，不是当前状态。
