...
if(NOT "$ENV{ZZLOGG_UI2_SMOKE_MS}" STREQUAL "${EXPECTED_SMOKE_MS}")
  message(FATAL_ERROR "Unexpected smoke deadline")
endif()
if(NOT "$ENV{ZZLOGG_UI2_SMOKE_APP_CONFIG_DIR}" STREQUAL "${EXPECTED_APP_CONFIG_DIR}")
  message(FATAL_ERROR "Unexpected app-config override")
endif()
if(NOT "$ENV{ZZLOGG_UI2_SMOKE_USER_DATA_DIR}" STREQUAL "${EXPECTED_USER_DATA_DIR}")
