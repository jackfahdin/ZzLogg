...
foreach(size IN ITEMS 16 32 48)
  ...
  set(installed "${contract_prefix}/share/icons/hicolor/${size}x${size}/apps/klogg.png")
  if(NOT EXISTS "${installed}")
    message(FATAL_ERROR "Missing installed compatibility icon: ${installed}")
  endif()
  file(SHA256 "${source}" source_hash)
  file(SHA256 "${installed}" installed_hash)
  if(NOT source_hash STREQUAL installed_hash)
    message(FATAL_ERROR "Installed ${size}px compatibility icon differs from source")
  endif()
endforeach()

set(source_svg "${SOURCE_ROOT}/src/app/images/hicolor/scalable/ZzLogg.svg")
set(installed_svg "${contract_prefix}/share/icons/hicolor/scalable/apps/klogg.svg")
if(NOT EXISTS "${installed_svg}")
  message(FATAL_ERROR "Missing installed compatibility icon: ${installed_svg}")
endif()
...
if(NOT source_svg_hash STREQUAL installed_svg_hash)
  message(FATAL_ERROR "Installed scalable compatibility icon differs from source")
endif()

message(STATUS "Linux compatibility icon install contract passed")
