...
if(WIN32)
  if(NOT EXISTS "${TEST_CONFIG_DIR}/Roaming/klogg/klogg.ini"
    ...
    message(FATAL_ERROR "UI2 application smoke did not write isolated INI files")
  endif()
else()
  ...
  if(isolated_settings_count LESS 2)
    message(FATAL_ERROR "UI2 application smoke did not write isolated settings files")
  endif()
endif()
