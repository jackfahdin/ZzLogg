...
zzlogg_run_isolated_smoke_process(
  ...
  TIMEOUT 15
  ENVIRONMENT ${config_env} "ZZLOGG_UI_SMOKE_MODE=destroy-search-edit"
...
if(lifetime_result EQUAL 0)
  message(FATAL_ERROR "UI smoke did not reject an invalidated asynchronous object")
endif()
...
if(diagnostic_index EQUAL -1)
  message(FATAL_ERROR
    "UI smoke did not report the invalidated object: ${lifetime_stderr}")
endif()
foreach(storage_entry storage-manifest.ini config/ZzLogg.ini
  ...
  if(NOT EXISTS "${data_root}/${storage_entry}")
    message(FATAL_ERROR "UI async lifetime smoke storage entry missing: ${data_root}/${storage_entry}")
  endif()
endforeach()
